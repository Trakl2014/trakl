...
Tooltip.prototype.updateMarker = function (marker) {
    this.marker_ = marker;
    this.draw();
}
...
Tooltip.prototype.animate = function () {
    this.marker_.setAnimation(google.maps.Animation.DROP);
}

Tooltip.prototype.stopanimation = function () {
    if (this.marker_.getAnimation() != null) {
        this.marker_.setAnimation(null);
    }
}

Tooltip.prototype.updateAlwaysOpen = function (alwaysOpen) {
